...
sub ConnectDatabase{
	...
	#$CONFIG_VARS::DB_H = DBI->connect("DBI:$CONFIG_VARS::db_connector:dbname=$CONFIG_VARS::db_name;host=$CONFIG_VARS::db_host;port=$CONFIG_VARS::db_port","$CONFIG_VARS::db_user","$CONFIG_VARS::db_passwd", {RaiseError => 1, AutoCommit => 1}) or die "Error: $DBI::errstr\n";
